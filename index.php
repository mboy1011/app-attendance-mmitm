    ...
    <main>
        <div class="container">
            <div class="z-depth-2 y-depth-2 x-depth-2 grey green-text lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px; margin-top: 100px; solid #EEE;">
                ...
                <div class="section"><center><img class="circle green white-text" width="100" src="./assets/img/slogo.png"></center></div>
                <div class="section"><center><b>S</b>tudent <b>A</b>ttendance <b>M</b>anagement <b>S</b>ystem</center></div>

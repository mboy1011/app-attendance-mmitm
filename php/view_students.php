...
<header>
      <div class="navbar-fixed">
        <nav>
          <div class="nav-wrapper white">
              <a href="#!" class="brand-logo center green-text">Students</a>
      ...
      <li>
        ...
        <li class="active"><a href="view_students.php" class="white-text">Students <i class="small material-icons left white-text">people_alt</i></a></li>
  ...
  <div class="row">
      <div id="man" class="col s12">
        ...
        <table id="datatable" class="responsive-table">
              ...
              <tbody>
                    <?php
                    $result = mysqli_query($db,"SELECT s.*,concat(co.course,' ',c.level,'-',c.section) as `class` FROM students s inner join `class` c on c.id = s.class_id inner join courses co on co.id = c.course_id order by s.name desc ");
                    $i=1;
